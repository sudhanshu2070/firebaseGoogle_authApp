...
import edu.uoc.uocvirtualclass.adapter.MyClassRecyclerViewAdapter;
...
public class ClassFragment extends Fragment {
    ...
    private MyClassRecyclerViewAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        adapter = new MyClassRecyclerViewAdapter(students);
